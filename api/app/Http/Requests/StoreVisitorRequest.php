...
class StoreVisitorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'visitor_id_type' => 'required|in:aadhar,pan,driving_license,passport,other',
            'visitor_id_number' => 'required|string|max:50',
    ...
    public function messages(): array
    {
        return [
            ...
            'visitor_id_type.required' => 'ID type is required',
            'visitor_id_type.in' => 'ID type must be one of: aadhar, pan, driving_license, passport, other',
            'visitor_id_number.required' => 'ID number is required',
