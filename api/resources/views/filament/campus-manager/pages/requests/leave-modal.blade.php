<div class="space-y-4">
        ...
        <div>
            ...
            <p class="text-sm">
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                    ...
                    @elseif(str_contains($status, 'Approved')) bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200
    ...
    <div>
        <span class="text-sm font-medium text-[#2F4F2F]/80 dark:text-[#2F4F2F]/80">Leave Period</span>
        <p class="text-sm text-[#2F4F2F] dark:text-[#2F4F2F]">{{ $fromDate }} - {{ $toDate }}</p>
    </div>
