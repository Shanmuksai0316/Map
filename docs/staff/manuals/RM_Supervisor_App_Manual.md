# MAP HMS Mobile User Manual - RM Supervisor

## Document Summary
- App: Staff App
- Role: RM Supervisor
- Dashboard Title: Repair & Maintenance
- Last Updated: February 18, 2026

## 1. Purpose In Simple Words
This guide explains RM Supervisor app usage in plain language. It covers each screen, each major button, expected behavior, and common mistakes so non-technical users can work confidently and test properly.

## 2. Role Scope
- Primary responsibility: Maintenance request lifecycle and RM checklist completion.
...
| --- | --- | --- |
| Checklist | Open maintenance checklist tasks. | During normal daily flow or whenever related alert appears. |
| Requests | Track and progress maintenance requests. | During normal daily flow or whenever related alert appears. |
| Comm Box | Read communications. | During normal daily flow or whenever related alert appears. |
| Profile | Open profile/history/logout. | During normal daily flow or whenever related alert appears. |
...
### Module 1: RM Requests
**Purpose:** Progress repair tickets through clear status transitions.

**UI Elements You Should See:**
- Request list limited to repair_maintenance type.
- Status badges map technical values to readable labels.
- Update modal shows timeline and next status only.

**Step-by-Step:**
1. Open Requests tile.
2. Open request details from card.
3. Use update action to move Open -> In Progress -> Complete.

**Expected Success Result:** Request state and badge reflect new status immediately.

**Common Error/Edge Cases:**
- If update fails, alert is shown and state remains unchanged.

### Module 2: RM Checklist + History
**Purpose:** Finish maintenance checklist and validate completed jobs in history.

**UI Elements You Should See:**
- Checklist screen for daily maintenance controls.
- History screen lists completed/resolved requests.

**Step-by-Step:**
1. Complete checklist tasks and submit.
2. Open Profile > History to verify completed jobs.

**Expected Success Result:** Daily tasks and ticket closures are documented.

**Common Error/Edge Cases:**
- Incomplete checklist blocks submission.
...
- Example: Resolve plumbing request and verify it appears as completed in RM history.
