  ...
  const fetchGatePassDetails = async () => {
    try {
      ...
      setGatePass({
        ...
        reason: 'Medical emergency - visiting hospital',
        status: 'approved',
        overnight: false,
        requested_at: '2025-10-29T10:00:00Z',
        valid_until: '2025-10-29T18:00:00Z',
        approved_at: '2025-10-29T10:30:00Z',
        approved_by: 'Dr. Smith (Rector)',
      ...
      setGateEntries([
        {
          id: 1,
          direction: 'out',
          out_time: '2025-10-29T11:00:00Z',
          recorded_at: '2025-10-29T11:00:00Z',
          recorded_by: 'Guard 1',
        },
      ]);
    } finally {
  ...
  if (!gatePass) {
    return (
      <View style={styles.errorContainer}>
        ...
        <Text style={styles.errorText}>Gate pass not found</Text>
        <TouchableOpacity
  ...
  return (
    <ScrollView
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Gate Pass Details</Text>
