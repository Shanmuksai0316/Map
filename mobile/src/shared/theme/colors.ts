...
export const colors = {
  ...
  // ═══════════════════════════════════════════════════════════════
  // BACKGROUNDS - Unified app background (matches theme.ts)
  // ═══════════════════════════════════════════════════════════════
  background: '#FFFFFF',        // Main page background (student & staff)
  surface: '#FFFFFF',           // Card backgrounds
  surfaceElevated: '#FAFAFA',   // Elevated cards
  surfaceMuted: '#F3F4F6',      // Section separators, zebra rows
  
  // ═══════════════════════════════════════════════════════════════
  // TEXT COLORS (Unified to brand primary)
  // ═══════════════════════════════════════════════════════════════
  textHeading: '#2F4F2F',       // Military Green for headings ✓
  text: '#2F4F2F',              // Main body text unified to brand primary
  textPrimary: '#2F4F2F',       // Alias for primary text
  textSecondary: '#2F4F2F',     // Secondary text also using brand primary
  textMuted: '#2F4F2F',         // Muted/placeholder text unified
  textOnPrimary: '#FFFFFF',     // Text on green backgrounds (kept white for contrast)
  textOnAccent: '#2F4F2F',      // Text on golden backgrounds using brand primary
