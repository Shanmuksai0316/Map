...
export const theme = {
  colors: {
    ...
    // ═══════════════════════════════════════════════════════════════
    // BACKGROUNDS - Unified app background
    // ═══════════════════════════════════════════════════════════════
    background: '#FFFFFF',        // Main page background (unified for student & staff)
    ...
    textMuted: '#2F4F2F',         // Muted text unified (placeholders/disabled)
  ...
  typography: {
    ...
    body1: {
      ...
      lineHeight: 1.6,
      letterSpacing: 0.5,
      color: '#2F4F2F', // Unified body text color
    },
    body2: {
      fontSize: 14,
      fontWeight: 'regular' as const,
