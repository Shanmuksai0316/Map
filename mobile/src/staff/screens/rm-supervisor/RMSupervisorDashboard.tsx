...
import { rmSupervisorIcons } from '../../../shared/assets/dashboard-icons/rm-supervisor-icons';
...
export const RMSupervisorDashboard: React.FC<Props> = ({ navigation }) => {
  ...
  const fetchDashboardData = useCallback(async () => {
    try {
      ...
      const [dashboardRes, profileRes] = await Promise.all([
        apiService.get('/mobile/supervisor/dashboard?type=rm'),
      ...
      console.error('Failed to fetch RM supervisor dashboard:', e);
  ...
  const actionTiles: ActionTile[] = [
    {
      id: 'checklist',
      title: 'Checklist',
      iconSvgXml: rmSupervisorIcons.checklist,
      color: theme.colors.primary,
      onPress: () => navigation.navigate('RMChecklist'),
    },
    {
      id: 'requests',
      title: 'Requests',
      iconSvgXml: rmSupervisorIcons.requests,
      color: theme.colors.primary,
      badge: stats?.pending_requests,
      onPress: () => navigation.navigate('RMRequests'),
    },
    {
      id: 'comm-box',
      title: 'Notice Board',
      iconSvgXml: rmSupervisorIcons.commBox,
      color: theme.colors.primary,
      badge: 0,
    ...
    },
    {
      id: 'profile',
      title: 'Profile',
      iconSvgXml: rmSupervisorIcons.profile,
      color: theme.colors.primary,
      onPress: () => navigation.navigate('RMProfile'),
    },
  ];
...
export default RMSupervisorDashboard;
