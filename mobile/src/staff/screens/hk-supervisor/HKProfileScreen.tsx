...
export const HKProfileScreen: React.FC<Props> = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.nameCard}>
          ...
          <Text style={styles.userRole}>Housekeeping Supervisor</Text>
        </View>
...
export default HKProfileScreen;
