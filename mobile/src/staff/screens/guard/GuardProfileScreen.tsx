...
export const GuardProfileScreen: React.FC<Props> = ({ navigation }) => {
  const { user, logout, selectedTenant } = useAuthStore();
  ...
  const handleHistory = () => {
    navigation.navigate('GuardHistory');
  };
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.nameCard}>
          <View style={styles.avatarContainer}>
            <Icon name="shield-account" size={80} color={theme.colors.primary} />
          </View>
          <Text style={styles.userName}>{user?.name || 'Security Guard'}</Text>
          <Text style={styles.userRole}>Security Guard</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>Security Guard</Text>
          </View>
          <View style={styles.divider} />

          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Employee ID</Text>
            <Text style={styles.detailValue}>{(user as any)?.employee_id || 'N/A'}</Text>
          </View>
          <View style={styles.divider} />
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{user?.hostel_name || 'N/A'}</Text>
          </View>
          <View style={styles.divider} />

          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Tenant</Text>
            <Text style={styles.detailValue}>{selectedTenant?.name || 'N/A'}</Text>
          </View>
        </View>
