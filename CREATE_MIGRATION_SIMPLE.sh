#!/bin/sh
# Simple method: Use PHP to write the file

docker exec map-hms-app php -r "
file_put_contents('/var/www/html/database/migrations/2025_01_15_000001_backfill_tenant_id_for_requests.php', '<?php
